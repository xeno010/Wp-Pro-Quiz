...
h[c].tip=1;g(document).bind("mouseup.tipEvent",function(a){var c=b.find(".wpProQuiz_tipp"),d=b.find('input[name="tip"]');c.is(a.target)||0!=c.has(a.target).length||d.is(a.target)||(c.hide("fast"),g(document).unbind(".tipEvent"))})},ajax:function(a,b,d){O&&(jQuery.support.cors=!0);g.post(WpProQuizGlobal.ajaxurl,a,b,d||"json");O&&(jQuery.support.cors=!1)},checkQuizLock:function(){S=1;d.methode.ajax({action:"wp_pro_quiz_admin_ajax",func:"quizCheckLock",data:{quizId:e.quizId}},function(a){void 0!=a.lock&&
(da=a.lock.is,a.lock.pre&&b.find('input[name="restartQuiz"]').hide());void 0!=a.prerequisite&&(ea=1,b.find(".wpProQuiz_prerequisite span").text(a.prerequisite));void 0!=a.startUserLock&&(fa=a.startUserLock);S=0;R&&d.methode.startQuiz()})},loadQuizData:function(){d.methode.ajax({action:"wp_pro_quiz_admin_ajax",func:"loadQuizData",data:{quizId:e.quizId}},function(a){a.toplist&&d.methode.handleToplistData(a.toplist);void 0!=a.averageResult&&d.methode.setAverageResult(a.averageResult,!0)})},setAverageResult:function(a,
...
g(this).parents(".wpProQuiz_listItem");var c=0;a.find('.wpProQuiz_questionList[data-type="multiple"] .wpProQuiz_questionInput').each(function(a){this.checked&&c++});b.trigger({type:"questionSolved",values:{item:a,index:a.index(),solved:c?!0:!1}})})},loadQuizDataAjax:function(a){d.methode.ajax({action:"wp_pro_quiz_admin_ajax",func:"quizLoadData",data:{quizId:e.quizId}},function(c){e.globalPoints=c.globalPoints;e.catPoints=c.catPoints;e.json=c.json;n.remove();b.find(".wpProQuiz_quizAnker").after(c.content);
ga=b.find('input[name="back"]');y=b.find('input[name="next"]');n=b.find(".wpProQuiz_quiz");u=b.find(".wpProQuiz_list");z=b.find(".wpProQuiz_results");v=b.find(".wpProQuiz_text");B=b.find(".wpProQuiz_time_limit");J=b.find(".wpProQuiz_toplistShowInButton");T=g();d.methode.initQuiz();a&&d.methode.startQuiz(!0)})},initQuiz:function(){d.methode.setClozeStyle();d.methode.registerSolved();y.click(function(){if(x&&!p[k.index()]&&(w||!q))return alert(WpProQuizGlobal.questionNotSolved),!1;d.methode.nextQuestion()});
...
b.find('input[name="wpProQuiz_pageLeft"]').click(function(){d.methode.showSinglePage(N-1)});b.find('input[name="wpProQuiz_pageRight"]').click(function(){d.methode.showSinglePage(N+1)})}};d.preInit=function(){d.methode.parseBitOptions();t.init();b.find('input[name="startQuiz"]').click(function(){d.methode.startQuiz();return!1});Z&&!H&&d.methode.checkQuizLock();b.find('input[name="reShowQuestion"]').click(function(){d.methode.showQustionList()});b.find('input[name="restartQuiz"]').click(function(){d.methode.restartQuiz()});
b.find('input[name="review"]').click(d.methode.reviewQuestion);b.find('input[name="wpProQuiz_toplistAdd"]').click(d.methode.addToplist);b.find('input[name="quizSummary"]').click(d.methode.showQuizSummary);b.find('input[name="endQuizSummary"]').click(function(){if(x)for(var a=0,c=b.find(".wpProQuiz_listItem").length;a<c;a++)if(!p[a])return alert(WpProQuizGlobal.questionsNotSolved),!1;I&&1==e.formPos&&!E.checkForm()||d.methode.finishQuiz()});b.find('input[name="endInfopage"]').click(function(){E.checkForm()&&
d.methode.finishQuiz()});b.find('input[name="showToplist"]').click(function(){n.hide();J.toggle()});b.bind("questionSolved",d.methode.questionSolved);Q||d.methode.initQuiz();aa&&d.methode.startQuiz()};d.preInit()};g.fn.wpProQuizFront=function(M){return this.each(function(){void 0==g(this).data("wpProQuizFront")&&g(this).data("wpProQuizFront",new g.wpProQuizFront(this,M))})}})(jQuery);
