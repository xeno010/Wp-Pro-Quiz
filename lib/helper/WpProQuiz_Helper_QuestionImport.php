...
class WpProQuiz_Helper_QuestionImport
{
     ...
     * @return WpProQuiz_Helper_QuestionImpoterInterface|null
     */
    public function factory($name, $type, $resource)
    {
        ...
        return $impoter instanceof WpProQuiz_Helper_QuestionImpoterInterface ? $impoter : null;
    }
    ...
    protected function runHooks()
    {
        if (!self::$booted) {
            ...
            do_action('wpProQuiz_questionImport_boot', $this);
        }
    }

    public function createJsonImporter($resource)
    {
        return WpProQuiz_Helper_JsonQuestionImporter::factory($resource);
    }
