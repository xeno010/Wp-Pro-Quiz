...
<div class="wrap wpProQuiz_quizOverall" style="">
	<h2>
		...
		<?php if(current_user_can('wpProQuiz_add_quiz')) { ?>
			<a class="add-new-h2" href="admin.php?page=wpProQuiz&action=addEdit"><?php echo __('Add quiz', 'wp-pro-quiz'); ?></a>
	...
	protected function getTable() {
		...
		return new WpProQuiz_View_QuizOverallTable($this->quizItems, $this->quizCount, $this->categoryItems, $this->perPage);
	}
