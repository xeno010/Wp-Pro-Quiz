...
<div class="wrap">
	...
	<ol style="list-style-type: disc;">
		<li><?php _e('Send us an e-mail', 'wp-pro-quiz'); ?> <a href="mailto:wp-pro-quiz@it-gecko.de" style="font-weight: bold;">wp-pro-quiz@it-gecko.de</a></li>
		...
		<li><?php _e('If you wish design adaption, we additionally need the name of your theme', 'wp-pro-quiz'); ?></li>
	</ol>
	
	<p>
		<?php _e('After receiving your e-mail we will verify your request on feasibility. After this you will receive e-mail from us with further details and offer.', 'wp-pro-quiz'); ?> 
	</p>
	<p>
		<?php _e('Extended support in first 6 months. Reported bugs and updates of WP Pro Quiz are supported. Exception are major releases (update of main version)', 'wp-pro-quiz'); ?>
	</p>
</div>
